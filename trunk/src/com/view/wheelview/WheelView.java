...
public class WheelView extends View {
    ...
    private void initData(Context context) {
        ...
        TEXT_SIZE = (int) context.getResources().getDimension(R.dimen.wheel_text_size);
    ...
    private int getMaxTextLength() {
        ...
        for (int i = Math.max(mCurrentItem - addItems, 0); i < Math.min(mCurrentItem + mVisibleItems,
    ...
    private void createLayouts(int widthItems, int widthLabel) {
        if (mItemsLayout == null || mItemsLayout.getWidth() > widthItems) {
            mItemsLayout = new StaticLayout(buildText(mIsScrollingPerformed), mItemsPaint, widthItems,
        ...
        if (!mIsScrollingPerformed && (mValueLayout == null || mValueLayout.getWidth() > widthItems)) {
    ...
    private void drawShadows(Canvas canvas) {
        ...
        mBottomShadow.setBounds(0, getHeight() - getHeight() / mVisibleItems, getWidth(), getHeight());
    ...
    private void drawItems(Canvas canvas) {
        ...
        System.out.println(-top + mScrollingOffset);
    ...
    private SimpleOnGestureListener gestureListener = new SimpleOnGestureListener() {
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
            ...
            int maxY = mIsCyclic ? 0x7FFFFFFF : mAdapter.getItemsCount() * getItemHeight();
    ...
    public boolean getScrollingPerformed() {
