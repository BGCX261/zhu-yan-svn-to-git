...
public class MusicPicker extends ListActivity implements View.OnClickListener, MediaPlayer.OnCompletionListener {
     ...
     */
    class TrackListAdapter extends SimpleCursorAdapter implements FastScrollView.SectionIndexer {
        ...
        public void bindView(View view, Context context, Cursor cursor) {
            ...
            if (name == null || name.equals(UNKNOWN_STRING)) {
        ...
        /**
         * Build a list of alphabetic characters appropriate for the current
         * locale.
         */
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.clock_music_picker);
        ...
        mAdapter = new TrackListAdapter(this, listView, R.layout.clock_track_list_item, new String[] {}, new int[] {});
    ...
    Cursor doQuery(boolean sync, String filterstring) {
        ...
        if (sync) {
            ...
            mQueryHandler.startQuery(MY_QUERY_TOKEN, null, mBaseUri, CURSOR_COLS, where.toString(), keywords,
                            mSortOrder);
        }
        return null;
    }
    ...
    public void onClick(View v) {
        ...
        case R.id.cancelButton:
            setResult(MusicRings.RESULT_CANCEL, null);
            finish();
            break;
        }
    }
