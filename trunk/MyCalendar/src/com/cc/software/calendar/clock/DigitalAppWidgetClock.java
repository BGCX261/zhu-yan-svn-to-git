 ...
 * Displays the time
 */
public class DigitalAppWidgetClock extends LinearLayout {
    ...
    public DigitalAppWidgetClock(Context context) {
        this(context, null);
    }

    public DigitalAppWidgetClock(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
