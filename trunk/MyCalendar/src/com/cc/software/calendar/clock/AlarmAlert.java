...
public class AlarmAlert extends Activity {
    ...
    private void updateSilencedText() {
        ...
        silenced.setText(getString(R.string.alarm_alert_alert_silenced, AlarmKlaxon.ALARM_TIMEOUT_SECONDS / 60));
    ...
    private void updateLayout() {
        ...
        SharedPreferences settings = getSharedPreferences(AlarmClock.PREFERENCES, 1);
    ...
    private void snooze() {
        ...
        final long snoozeTime = System.currentTimeMillis() + (1000 * 60 * SNOOZE_MINUTES);
        final long nextAlarm = Alarms.calculateNextAlert(AlarmAlert.this).getAlert();
        String displayTime = null;
        if (nextAlarm < snoozeTime) {
            final Calendar c = Calendar.getInstance();
            c.setTimeInMillis(nextAlarm);
            displayTime = getString(R.string.alarm_alert_snooze_not_set, Alarms.formatTime(AlarmAlert.this, c));
            mState = DISMISS;
        } else {
            Alarms.saveSnoozeAlert(AlarmAlert.this, mAlarmId, snoozeTime, mLabel);
        ...
        CommonUtil.showToastMessage(displayTime, AlarmAlert.this);
